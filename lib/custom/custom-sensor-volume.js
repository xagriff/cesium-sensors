...
const SensorVolume = require('../sensor-volume.glsl');
const CustomSensorVolumeFS = require('./custom-sensor-volume-fs.glsl');
const CustomSensorVolumeVS = require('./custom-sensor-volume-vs.glsl');
